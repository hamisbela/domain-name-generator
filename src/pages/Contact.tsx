          ...
          <div className="space-y-8">
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">contact@domainnamegenerator.xyz</p>
              </Card>
            </div>
            ...
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">@AISloganGen</p>
              </Card>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea 
                    id="message" 
                    required 
                    className="min-h-[150px] border-2 focus:border-orange-400" 
                  />
                </div>
